        ...
        <div class="container mx-auto">    
            ...
            <section class="flex flex-wrap w-full justify-center items-center py-8">
                @foreach($items as $item)
                    <div class="bg-gray-100 flex flex-col justify-end m-4" style="height: 240px; width: 180px; background-image: url('{{ $item->photo_url }}'); background-size: cover; background-position: center">
